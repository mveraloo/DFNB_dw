USE [DFNB3]
GO
/****** Object:  StoredProcedure [dbo].[usp_HandleRefEnteg]    Script Date: 3/29/2021 6:10:03 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[usp_HandleRefEnteg] (@v_op as varchar(10))
AS
...
-----   ----------   -----------   -------------------------------------------------------------------------------
1.0     03/29/2021   Mireya       1. Built this table for LDS BC IT243
...
--1.2.11) Transaction Type Dimension
